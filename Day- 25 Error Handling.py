"""
syntax error:Occurs with python syntax is incorrect
-----------
-----------
for i in range(1,10)
    print(i)
...
for j in range(1,10):
    print(j)
Indentation Error:It occurs when indwntation is incorrect
-----------------
...
Value error:occurs when value is of the correct type but invalid
----------
